...
function px = NaoRH_fwd_px(thetas)
    ...
    px = (21*cos(t1)*cos(t2))/20 - (1137*sin(t4)*(sin(t1)*sin(t3) + cos(t1)*cos(t3)*sin(t2)))/1000 + (1137*cos(t1)*cos(t2)*cos(t4))/1000;
 
    
    %px = z4*(cos(t3)*sin(t1) + cos(t1)*sin(t2)*sin(t3)) + x3*(sin(t4)*(sin(t1)*sin(t3) - cos(t1)*cos(t3)*sin(t2)) + cos(t1)*cos(t2)*cos(t4)) + x4*(sin(t4)*(sin(t1)*sin(t3) - cos(t1)*cos(t3)*sin(t2)) + cos(t1)*cos(t2)*cos(t4)) + x2*cos(t1)*cos(t2) - y2*cos(t1)*sin(t2);
