...
function pz = NaoRH_fwd_pz(thetas)
    ...
    pz = 1 - (1137*sin(t4)*(cos(t1)*sin(t3) - cos(t3)*sin(t1)*sin(t2)))/1000 - (1137*cos(t2)*cos(t4)*sin(t1))/1000 - (21*cos(t2)*sin(t1))/20; 
 
    
    %pz = z1 + z4*(cos(t1)*cos(t3) - sin(t1)*sin(t2)*sin(t3)) + x3*(sin(t4)*(cos(t1)*sin(t3) + cos(t3)*sin(t1)*sin(t2)) - cos(t2)*cos(t4)*sin(t1)) + x4*(sin(t4)*(cos(t1)*sin(t3) + cos(t3)*sin(t1)*sin(t2)) - cos(t2)*cos(t4)*sin(t1)) - x2*cos(t2)*sin(t1) + y2*sin(t1)*sin(t2);
